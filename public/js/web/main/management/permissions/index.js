const url = $('#table-permissions').data('url');
const id = '';
                ...
                render: function(data, type, row, meta) {
                    ...
                    <div class="btn-group dropleft">
                        ...
                        <div class="dropdown-menu" >
                                    <a href="#edit-user" id="update-user" data-toggle="modal" data-id="${row.id}" data-name="${row.name}" data-display="${row.display}"  data-menu="${row.menu}" class="upload dropdown-item"  title="Upload Lampiran" style="text-decoration: none;color: black;"><span class="mdi mdi-file-edit-outline"></span> Edit Roles</a>
