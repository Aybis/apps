            ...
            <li class="dropdown notification-list">
                <a class="nav-link dropdown-toggle nav-user arrow-none mr-0" data-toggle="dropdown" id="topbar-userdrop"
                    ...
                    <span class="account-user-avatar">
                        <img src="https://ui-avatars.com/api/?name=Muchtar" alt="user-image" class="rounded-circle">
                    </span>
                    <span>
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated topbar-dropdown-menu profile-dropdown"
                    ...
                    <!-- item-->
                    <a class="dropdown-item notify-item" href="#" onClick="event.preventDefault(); document.getElementById('logout-form').submit();"> <i class="mdi mdi-logout mr-1"></i>
                        <span>Logout</span>
