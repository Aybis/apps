                ...
                <div class="form">
                    ...
                    <form action="{{ route('login') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="username" id="email" type="text" class="form-control {{$errors->has('username') ? 'is-invalid' : '' }}" value="{{ old('username') }}" autofocus autocomplete="off">
                        </div>
                        <div class="form-group">
                            <label for="password">Password</label>
                            <input name="pwldap" type="password" id="password" class="form-control" required>
